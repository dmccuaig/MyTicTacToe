...
namespace MyTicTacToe
{
    public abstract class View
    {
        ...
        public abstract TicTacToeMove GetPlayerMove(char[,] _board);
        public abstract void ShowState(TicTacToeMove aiMove);
    }

    public class ConsoleView : View
    {
        ConsoleReader positionReader = new ConsoleReader("Move (1-9)", null, new Regex("[1-9]"));
        ...
        public override TicTacToeMove GetPlayerMove(char[,] board)
        {
            int order = GetOrder(board);
            ...
            for (;;)
            {
                string response = positionReader.GetString();
            ...
            return new TicTacToeMove(board, row, col);
        }
